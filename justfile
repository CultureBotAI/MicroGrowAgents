...
gh-add-topics:
  gh repo edit --add-topic "MicroGrowAgents,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/CultureBotAI/MicroGrowAgents/collaborators/dragon-ai-agent -X PUT -f permission=push
