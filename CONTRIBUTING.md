# Contributing to MicroGrowAgents

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
MicroGrowAgents. These guidelines are not strict rules.
...
The MicroGrowAgents team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the MicroGrowAgents technical leads
...
[issues]: https://github.com/CultureBotAI/MicroGrowAgents/issues/
[pulls]: https://github.com/CultureBotAI/MicroGrowAgents/pulls/
